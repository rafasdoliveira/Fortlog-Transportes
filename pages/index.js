    ...
    <div>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.cardstop}>
          <CardIndex
            image="/assets/images/icons/index/icons8-relatório-gráfico-60.png"
            title=""
            text="Relatórios personalizados conforme as necessidades do cliente"
          />
          <CardIndex
            image="/assets/images/icons/index/icons8-semi-truck-side-view-50.png"
            title=""
            text="Maior agilidade para a logística inbound da sua empresa"
          />
          <CardIndex
            image="assets/images/icons/index/icons8-1-stop-flight-64.png"
            title=""
            text="Cadastro nos principais aeroportos facilitando a operação
          logística"
          />
          <CardIndex
            image="assets/images/icons/index/icons8-mover-por-carrinho-50.png"
            title=""
        ...
        <div className={styles.cardsdown}>
          <CardIndex
            image="assets/images/icons/index/icons8-relógio-despertador-48.png"
            title=""
            text="Menor prazo de entrega e coleta"
          />
          <CardIndex
            image="assets/images/icons/index/icons8-escudo-de-segurança-verde-50.png"
            title=""
            text="Carga assegurada"
          />
          <CardIndex
            image="assets/images/icons/index/icons8-pesquisar-mais-48.png"
            title=""
            text="Rastreabilidade da sua mercadoria"
          />
          <CardIndex
            image="assets/images/icons/index/icons8-garantia-60.png"
            title=""
